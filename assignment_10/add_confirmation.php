<?php 
	...
	if (!isset($_POST['title']) || trim($_POST['title']) == '') {
		...
		#TODO
		$sql = "INSERT INTO dvd_titles (title, release_date, award, format_id, genre_id, label_id, rating_id, sound_id)
				VALUES ('$title', $release_date, '$award', $format_id, $genre_id, $label_id, $rating_id, $sound_id);"; 	
